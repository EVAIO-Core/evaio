...
func addAccount(address string, amount int64, accs []genaccounts.GenesisAccount) []genaccounts.GenesisAccount{
	...
	accs = append(accs, genaccounts.GenesisAccount{
		Address: addr,
		Coins:   sdk.Coins{sdk.NewCoin(sdk.DefaultBondDenom, sdk.TokensFromConsensusPower(amount))},
	})
	return accs
}
	...
	for i := 0; i < numValidators; i++ {
		...
		accs = append(accs, genaccounts.GenesisAccount{
			...
			Coins: sdk.Coins{
				...
				sdk.NewInt64Coin(sdk.DefaultBondDenom, 10000000*1000000000),
			},
		})

		valTokens := sdk.TokensFromConsensusPower(10000000)
